<template>
  <div class="w-full min-h-screen bg-seaBlue flex flex-col justify-start items-center" ref="containerDiv">
    ...
    <header class="w-full h-screen relative">
      ...
      <h1 class="absolute bottom-0 w-full text-[2rem] xl:text-[4rem] font-sneakers-500 text-white text-center bg-seaBlue shadow-[0_-32px_32px_32px_#384e9f]" ref="mainTitle">
        {{ currentRegion.title }}
      </h1>
    </header>
